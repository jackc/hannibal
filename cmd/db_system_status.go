...
// dbSystemStatusCmd represents the db init command
var dbSystemStatusCmd = &cobra.Command{
	Use:   "system-status",
	Short: "display systeem database status",
...
func init() {
	dbCmd.AddCommand(dbSystemStatusCmd)
}
